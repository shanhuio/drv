...
var grubConfigMap = map[string]*grubConfig{
	...
	"burmilla/os:v1.9.3": {
		Vmlinuz:  "/boot/vmlinuz-4.14.248-burmilla",
		BootArgs: defaultBootArgs,
		Initrd:   "/boot/initrd-v1.9.3",
	},
	"burmilla/os:v1.9.6": {
		Vmlinuz:  "/boot/vmlinuz-4.14.300-burmilla",
		BootArgs: defaultBootArgs,
		Initrd:   "/boot/initrd-v1.9.6",
	},
	"burmilla/os:v2.0.1": {
		Vmlinuz:  "/boot/vmlinuz-5.10.211-burmilla",
		BootArgs: defaultBootArgs,
